...
class mylora(LoRa):
    ...
    def on_rx_done(self):
        ...
        elif mens=="pumpfrontOFFmain":
            print("Received data request pumpfrontOFFmain")
            time.sleep(2)
            print ("Send mens: OKpumpfrontOFFmain")
            self.write_payload([255, 255, 0, 0, 79, 75, 112, 117, 109, 112, 102, 114, 111, 110, 116, 79, 70, 70, 109, 97, 105, 110, 0])
            self.set_mode(MODE.TX)
        elif mens == "11":
            print("Button on!")
